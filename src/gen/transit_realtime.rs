...
#[derive(Clone, PartialEq, ::prost::Message)]
    pub struct StopTimeUpdate {
        ...
        #[prost(enumeration="super::vehicle_position::OccupancyStatus", optional, tag="7")]
...
#[derive(Clone, PartialEq, ::prost::Message)]
        pub struct StopTimeProperties {
            ...
            /// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
            #[prost(enumeration="stop_time_properties::DropOffPickupType", optional, tag="3")]
            pub pickup_type: ::core::option::Option<i32>,
            /// The updated drop off of the vehicle at the stop.
            /// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
            #[prost(enumeration="stop_time_properties::DropOffPickupType", optional, tag="4")]
            ...
            impl DropOffPickupType {
                ...
                pub fn as_str_name(&self) -> &'static str {
                    match self {
                        ...
                        DropOffPickupType::CoordinateWithDriver => "COORDINATE_WITH_DRIVER",
                    }
                }
                /// Creates an enum from field names used in the ProtoBuf definition.
                pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
#[derive(Clone, PartialEq, ::prost::Message)]
    pub struct CarriageDetails {
        ...
        /// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
        #[prost(enumeration="OccupancyStatus", optional, tag="3", default="NoDataAvailable")]
        pub occupancy_status: ::core::option::Option<i32>,
...
pub struct Alert {
    ...
    #[prost(enumeration="alert::SeverityLevel", optional, tag="14", default="UnknownSeverity")]
...
pub struct VehicleDescriptor {
    ...
    #[prost(enumeration="vehicle_descriptor::WheelchairAccessible", optional, tag="4", default="NoValue")]
...
pub struct Stop {
    ...
    #[prost(enumeration="stop::WheelchairBoarding", optional, tag="13", default="Unknown")]
